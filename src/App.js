...
function App() {
  ...
  return (
    <div className="App">
      ...
      <Tooltip tooltipText='Какая-то всплывающая подсказка' position='left'>
        <Typography>
      ...
      <Tooltip tooltipText='Подсказка' position='top'>
        fwefwerfwref
      </Tooltip>
      ...
      <Tooltip tooltipText='Подсказка' position='bottom'>
        fwefwerfwref
      </Tooltip>
      ...
      <Tooltip tooltipText='Подсказка' position='left'>
        fwefwerfwref
      </Tooltip>
      ...
      <Tooltip tooltipText='Подсказка' position='right'>
        fwefwerfwref
      </Tooltip>
